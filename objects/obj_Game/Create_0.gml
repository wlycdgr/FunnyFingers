...
scr_Splitsfont_Set_Tweaks(move_p, [.099, 0.01, 0, 0, 15]);
move_p.y = 0.755 * window_height;

move_o = instance_create_layer(0, 0, "Splitsfont", obj_Splitsfont_String);
scr_Splitsfont_Set_Text(move_o, "O");
scr_Splitsfont_Set_Tweaks(move_o, [0.105, 0.008, 0, 0, -15]);
move_o.y = 0.751 * window_height;

move_i = instance_create_layer(0, 0, "Splitsfont", obj_Splitsfont_String);
scr_Splitsfont_Set_Text(move_i, "I");
scr_Splitsfont_Set_Tweaks(move_i, [0.095, 0.01, 0, 0, 15]);
move_i.y = 0.757 * window_height;
