...
scr_Splitsfont_Set_Text(to_move_string, "TO MOVE THE FUNNY FINGERS");
...
//qweiop_string = instance_create_layer(0, 0, "Splitsfont", obj_Splitsfont_String);
//scr_Splitsfont_Set_Text(qweiop_string, "QWEIOP");

//sf_tweaker = instance_create_layer(0, 0, "Splitsfont", obj_Splitsfont_Tweaker);
//scr_Splitsfont_Tweaker_Add_String(sf_tweaker, use_string);
//scr_Splitsfont_Tweaker_Add_String(sf_tweaker, qweiop_string);
//scr_Splitsfont_Tweaker_Add_String(sf_tweaker, to_move_string);
...
scr_Splitsfont_Set_Tweaks(excellent_work_string, [0.15, qweiop_unselected_weight, 0.05, 0, 0]);
excellent_work_string_y = 0.38 * window_height;
...
scr_Splitsfont_Set_Tweaks(good_luck_string, [0.15, qweiop_unselected_weight, 0.05, 0, 0]);
good_luck_string_y = 0.38 * window_height;
