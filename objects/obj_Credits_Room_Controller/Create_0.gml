...
for (var i = 0; i < backer_count; i++) {
	...
	//scr_Splitsfont_Set_Weight(backer_string, 0.004); //0.001 + backer_infos[1] * 0.001);
	//scr_Splitsfont_Set_RotationSpeed(backer_string, 60 + (3600 / (1 + backer_infos[1])));
	//scr_Splitsfont_Set_Size(backer_string, 0.05);
